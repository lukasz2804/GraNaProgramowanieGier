    ...
    public class Triangulator : MonoBehaviour
    {
        ...
        public void InitNeighboursWithCollision(Vector2 pt, float radius)
        {
            for (int i = 0; i < neighbours.Count; i++)
            {
                ...
                {
                    scTr.InitCollisionClipper(pt, radius);
        ...
        public void InitCollisionClipper(Vector2 pt, float dmgRadius)
        {
            //  Debug.Break();
            ...
            subj.Add(new List<IntPoint> (lst.Count));
            ...
            clip.Add(new List<IntPoint>(numberOfPoints));
            Vector2 ctrV;
            ctrV = pt;
            ctrV.x += dmgRadius;
            ...
            for (int i = 0; i < numberOfPoints; i++)
            {
                ...
                ctrV = RotateVecPFromI(pt, -degreeDelta, ctrV);
            }
